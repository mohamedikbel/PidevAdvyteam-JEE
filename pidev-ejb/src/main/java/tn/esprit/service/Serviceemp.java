...
public class Serviceemp implements Serviceempremote {
	...
	TypedQuery <Employe> query = (TypedQuery<Employe>) em.createQuery("Select e from Employe e where e.email = :mail and e.Password = :pass",Employe.class);	
...
String[] parts = result.split("\n");
	...
	public Employe getemployemail(String Mail) {
		TypedQuery <Employe> query = (TypedQuery<Employe>) em.createQuery("Select e from Employe e where e.email = :mail ",Employe.class);	
		query.setParameter("mail", Mail);
	...
	public Employe getemployemailqr(String Mail, String Qr) {
		TypedQuery <Employe> query = (TypedQuery<Employe>) em.createQuery("Select e from Employe e where e.email = :mail and e.codeqr = :pass",Employe.class);	
		query.setParameter("mail", Mail);
	...
	public void updatere(String Mail, String Qr,String pass) {
		...
		String qr= code;
		Query query = em.createQuery("Update Employe e SET e.codeqr=:Depnom2 , e.Password=:pass where e.email=:mail and e.codeqr=:oldqr");	
